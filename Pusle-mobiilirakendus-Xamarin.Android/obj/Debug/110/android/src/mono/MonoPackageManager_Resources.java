...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Pusle-mobiilirakendus-Xamarin.Android.dll" comes first in this list. */
		"Pusle-mobiilirakendus-Xamarin.Android.dll",
		"FormsViewGroup.dll",
		"Pusle-mobiilirakendus-Xamarin.dll",
